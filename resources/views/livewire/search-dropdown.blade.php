<div class="relative mt-3 md:mt-0" x-data="{ isOpen: true }" @click.away="isOpen = false">
    <input
        ...
        type="text"
        class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search (type at least 3 letters)"
        x-ref="search"
        @keydown.window="
    ...
    >
    <span class="search_text">Press '/' to focus</span>
